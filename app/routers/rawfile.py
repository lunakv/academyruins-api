...
@router.get('/cr/{set_code}', status_code=308, responses={
    308: {"content": None},
    404: {"description": "CR for the specified set code not found", "model": Error}
})
@no422
async def raw_cr_by_set_code(request: Request, response: Response, set_code: str = Path(description="Code of the "
                                                                                                    "requested set"),
                             ):
    """
